...
const ResizeAndDraggable = () => {
  ...
  const [disableDraggin, setDisableDraggin] = useState(false);
  ...
  const handleTouchStart = () => {
    setDisableDraggin(true);
    if (timeoutRef.current) {
      clearTimeout(timeoutRef.current);
    }
    timeoutRef.current = setTimeout(() => {
      setDisableDraggin(false);
    }, 1000);
  };
  ...
  return (
    <div className="fixed inset-0 h-full w-full">
      <Rnd
        ...
        bounds="window"
        disableDragging={disableDraggin}
        enableResizing={{
          top: false,
      ...
      >
        <div className="w-full h-full">
          <div    className="  relative w-full h-full bg-[blue] overflow-auto">
            <button
              ...
              {(status) => (
                ...
                >
                  {accordin && (
                    ...
                    >
                      <div  onTouchStartCapture={handleTouchStart} onTouchStart={handleTouchStart} className="checkListFirstTxt mt-10">
                        <span>
